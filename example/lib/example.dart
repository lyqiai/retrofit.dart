...
abstract class RestClient {
  ...
  //
  // @POST("/post")
  // Future<String> postFormData2(@Part() List<Map<String, dynamic>> task, @Part() List<String> tags, @Part(contentType: 'application/json') File file);
  //
  // @POST("/post")
  // Future<String> postFormData3({@Part(value: "customfiles", contentType: 'application/json') List<File> files, @Part() File file});
  //
  // @POST("/post")
  // Future<String> postFormData6({@Part(value: "customfiles") List<List<int>> files, @Part() List<int> file});
  //
  // @POST("/post")
